...
public class TransferController {
	...
	@PostMapping("/toself")
	public String selfTransfer(@ModelAttribute("toself") SelfTransfer selfTransfer,Principal principal)
	{
		service.selfTransfer(selfTransfer, principal.getName());
		return "transfer";	
	}
	...
	public String transferToOthers(@ModelAttribute("toothers") TransferOthersAccount othersTransfer,Principal principal)
	{
		otherService.transferToOthers(othersTransfer, principal.getName());
		return "toothers";
	}
